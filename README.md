...
├── README.md                         # 项目说明文件
├── src/                              # 源代码目录
│   ├── exp_integration.py            # 指数函数 e^x 的数值积分实验
│   └── poly_integration.py           # 多项式函数 x²+0.5 的数值积分实验
├── images/                           # 生成的可视化图像
│   ├── numerical_integration_results.png  # 三种方法比较图（指数函数）
│   ├── riemann_sum_convergence.png        # 黎曼和逼近效果图
│   └── rect_vs_trap.png        # 矩形法与梯形法对比图
├── requirements.txt                  # Python依赖库列表
└── report/                           # 实验报告文档
    └── 定积分数值计算方法.pdf        # 完整实验报告
```
...
**提示**：如果运行时报中文字体错误，可修改代码中的字体设置为系统已有字体。
